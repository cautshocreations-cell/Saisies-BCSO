...
alter table public.inventory_records add column if not exists description text not null default '';
update public.inventory_records
set description = info_content
where description = '' and info_label = 'Aucun fichier' and info_content <> '';
